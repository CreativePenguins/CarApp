...
/**
 * Class extends arc progress library found here:
 * https://github.com/lzyzsd/CircleProgress/blob/master/library/src/main/java/com/github/lzyzsd/circleprogress/ArcProgress.java
 * with a fix to make sure bottom text doesn't get cut off
 */
public class FixedArcProgress extends com.github.lzyzsd.circleprogress.ArcProgress {
    ...
    public FixedArcProgress(Context context) {
        this(context, null);
    }

    public FixedArcProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixedArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
